...
alter table Voter_ls_01 add constraint voterfk1 foreign key(candidate_id) references Candidate(candidate_id);
alter table Voter_ls_01 add constraint voterfk2 foreign key(constituency_id) references Constituency(constituency_id);
alter table Voter_ls_01 add constraint voterfk3 foreign key(state_constituency_id) references Constituency(constituency_id);
alter table Voter_kar_01 add constraint voterfk4 foreign key(candidate_id) references Candidate(candidate_id);
alter table Voter_kar_01 add constraint voterfk5 foreign key(constituency_id) references Constituency(constituency_id);
alter table Voter_kar_01 add constraint voterfk6 foreign key(state_constituency_id) references Constituency(constituency_id);
